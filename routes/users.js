...
// https://6bd9bf9ce60b47a6aa8de56ca048a9a5.vfs.cloud9.us-east-1.amazonaws.com/:user_id/teamyusuf/create
router.post('/:user_id/teamyusufs/create', user_controller.create_teamyusuf_post);

// https://6bd9bf9ce60b47a6aa8de56ca048a9a5.vfs.cloud9.us-east-1.amazonaws.com/:user_id/tasks/:teamyusuf_id/destroy
router.get('/:user_id/teamyusufs/:teamyusuf_id/destroy', user_controller.delete_user_teamyusuf_get);
